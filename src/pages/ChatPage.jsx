  ...
  return h(
    ...
    h(
      ...
      h(
        ...
        {
          id: "pm-e2e-status",
          className: "pm-e2e-status",
        },
        "Standard PM · tap 🔒 to enable encrypted messages"
      ),
      "\n        ",
      h(
        "div",
        {
          style: { padding: "0.5rem", borderBottom: "2px solid var(--text-color)", background: "var(--bg-color)" },
        },
        "\n            ",
        h("input", {
            type: "text",
            ...
            style: { width: "100%", margin: "0", padding: "0.4rem 0.8rem", border: "2px solid var(--text-color)", borderRadius: "4px", fontSize: "0.85rem", fontFamily: "inherit", background: "var(--bg-color)", color: "var(--text-color)" },
          }),
        "\n        "
      ),
      "\n        ",

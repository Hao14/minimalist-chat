---
title: "Protected Ollama Public Gateway"
source_kind: markdown
source_path: "docs/ollama-public-gateway.md"
source_sha256: 5ec37ba96912547e0d4e12880701fa6cfb79e0552f52b6a5b29c4149255aea1c
...
> Source: `docs/ollama-public-gateway.md` · SHA-256: `5ec37ba96912…`
...
these fixed tiers: requests 1–10 use protected Ollama, requests 11–50 use
Cloudflare Workers AI, and requests 51–90 use Groq. A 91st simultaneous request receives
HTTP 429 with `AI_CAPACITY_FULL`. This is overflow concurrency, not a durable
job queue; request 91 is not stored for later processing.
...
`cloudflared` tunnel connector token. Routed requests never silently switch to
another provider after a lease is assigned; responses and audit records include
the actual provider and model. The router state contains only random lease IDs,
